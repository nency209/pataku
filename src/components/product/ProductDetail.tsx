          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              {product.images.map((image, index) => (
                <div
                  key={index}
                  className="relative aspect-square bg-white rounded-lg overflow-hidden border-2 border-gray-200 hover:border-[var(--color-accent)] cursor-pointer"
                >
                  <Image
                    src={image}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 pt-6 border-t">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {product.categories.map((category) => (
                    <span
                      key={category}
                      className="text-sm text-gray-600 hover:text-[var(--color-accent)] cursor-pointer"
                    >
                      {category}
                    </span>
                  ))}
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <button className="text-muted hover:text-blue-600 transition-colors">
                    <Facebook className="w-5 h-5" />
                  </button>
                  <button className="text-muted hover:text-blue-400 transition-colors">
                    <Twitter className="w-5 h-5" />
                  </button>
                  <button className="text-muted hover:text-pink-600 transition-colors">
