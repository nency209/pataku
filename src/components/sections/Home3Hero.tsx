    ...
    <section className="">
     <div className="w-full ">
      ...
      <div className="absolute left-1/2 -translate-x-3/4 inset-0 flex flex-col justify-center items-start px-8 md:px-20 text-white">
        ...
        <h2 className="text-[44px] font-bold text-black font-rubik my-4 max-w-xl">
          {slides[current].description}
        </h2>
        <button className="bg-primary text-white px-6 py-2 rounded bg-hover hover:cursor-pointer transition">
